...
<div class="list w1210 bc mt10">
    ...
    <div class="list_left fl mt10">
        ...
        <div class="catlist">
            ...
            <h2><?php echo $goods_category->name ?></h2>
            <div class="catlist_wrap">
                <?php $children =\frontend\models\Goods_category::findAll(['parent_id'=> $goods_category->id]) ?>
                <?php foreach ( $children as$k=>$child  ):?>
                    <div class="child">
                    <h3 <?php echo $child->id==$id ? 'class="on"' : ''?>><b></b><?php echo $child->name ?></h3>
                        <ul <?php echo $k==0? '' : 'class="none" '?> >
                            <?php $cates =\frontend\models\Goods_category::findAll(['parent_id'=> $child->id]) ?>
            ...
            <div class="filter_wrap">
                <dl>
                    ...
                    <?php foreach ($brands as $brand):?>
                        <dd><a href=""><?php echo $brand->name?></a></dd>
                    <?php endforeach;?>
                </dl>
        ...
        <div class="goodslist mt10">
            <ul>
                <?php foreach ($goodses as $goods):?>
                        <li>
                            <dl>
                                <dt><?=Html::img($goods->logo ?  'http://admin.yi2shop.com'.$goods->logo: '@web/images/goods1.jpg')?></dt>
                                <dd><?php echo \yii\bootstrap\Html::a($goods['name'],['other/good','id'=>$goods->id]) ?></dt>
                                <dd><strong>￥<?php echo $goods->shop_price ?></strong></dt>
