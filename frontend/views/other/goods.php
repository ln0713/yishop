...
<!--                    <a href="images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                    <a href="<?php echo 'http://admin.yi2shop.com'.$goods->logo ?>" class="jqzoom" rel="gal1">
                        <img src="<?php echo ('http://admin.yi2shop.com'.$goods->logo)?>" alt="" width="360"/>
                    <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo 'http://admin.yi2shop.com'.$goods->logo ?>',largeimage: '<?php echo 'http://admin.yi2shop.com'.$goods->logo ?>'}">
                                    <?=Html::img('http://admin.yi2shop.com'.$goods->logo)?></a>
                            </li>
                            <?php foreach ($imgs as $img):?>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: '<?php echo 'http://admin.yi2shop.com'.$img->img?>',largeimage: '<?php echo 'http://admin.yi2shop.com'.$img->img?>'}">
                                    <?=Html::img('http://admin.yi2shop.com'.$img->img)?></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
                ...
                <form action="<?=\yii\helpers\Url::to(['flow/add'])?>" method="post" class="choose">
                    <ul>
                        ...
                        <li>
                            <dl>
                                <dt>&nbsp;</dt>
                                <dd><input type="hidden" name="goods_id" value="<?=$goods->id?>"/>
