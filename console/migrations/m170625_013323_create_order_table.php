 ...
 */
class m170625_013323_create_order_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('order', [
            'id' => $this->primaryKey(),
//            member_id	int	用户id
            'member_id'=> $this->integer(11)->comment('用户id'),
//name	varchar(50)	收货人
...
//payment_id	int	支付方式id
            'payment_id'=> $this->integer(11)->comment('支付方式id'),
...
//status	int	订单状态（0已取消1待付款2待发货3待收货4完成）
            'status'=> $this->integer(11)->comment('订单状态'),
